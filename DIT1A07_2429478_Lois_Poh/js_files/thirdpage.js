...
let x = setInterval(function () {
    ...
    let days = Math.floor(distance/ (1000*60*60*24)); // calculate the whole number of whole days remaining until the countdown date 
    //1000 miliseconds per second * 60 seconds per minute * 60 seconds per hour * 24 hours per day
    let hours = Math.floor((distance % (1000*60*60*24)/(1000*60*60))); //number of hours remaining after removing the days. modulus operator '%' to get the remaining miliseconds
